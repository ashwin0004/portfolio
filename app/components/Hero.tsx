      ...
      <div className="mx-auto flex h-full max-w-7xl flex-col items-center gap-12 px-6 lg:flex-row">
        ...
        <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <h1 className="mt-8 text-4xl font-bold leading-tight tracking-tight sm:text-6xl text-on-surface">
            ...
            <span className="text-secondary">fast, scalable & user-focused</span> web experiences.
          </h1>

          <p className="mt-6 max-w-xl text-lg text-on-surface-variant leading-relaxed">
            Specializing in React.js, JavaScript, and UI/UX Design. Transforming complex problems into elegant, intuitive digital solutions.
          </p>
          ...
          <div className="mt-8 flex items-center gap-6">
            <a href="#" className="flex items-center gap-2 text-sm text-on-surface-variant transition-colors hover:text-primary">
